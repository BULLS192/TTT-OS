// TTT OS v0.8.2 — Vendor & Supplier directory bridge
// Supabase is canonical. The consolidated CRM/ERP workbook is the editable Workspace surface; the original vendor directory remains a migration/reference source.
(function(){
  const DIRECTORY_URL='https://docs.google.com/spreadsheets/d/1N67KaF8q-0FnVaYN41zI5lTVlUoj06pHNAuF1TQrJ8I/edit';
  const LEGACY_DIRECTORY_URL='https://docs.google.com/spreadsheets/d/1crOoPQirn3TS1anibJN67lZN7CWf1uqCLEg6rxd4g5g/edit';
  ...
  function injectVendorModule(){
    ...
    if(main && !document.getElementById('vendors')){
      ...
      section.innerHTML=`
        ...
        <div class="workflow-note"><strong>System of record:</strong> Supabase now owns company, contact and vendor records. The CRM/ERP workbook is the Google Workspace operating surface, while the original vendor directory remains available as a migration/reference source.</div>
        <div class="stats">
        ...
        <div class="panel">
          ...
          <div class="table-wrap"><table><thead><tr><th>Resource</th><th>Purpose</th><th></th></tr></thead><tbody>
            <tr><td><strong>TTT Business Operations — CRM & ERP</strong></td><td>Consolidated Workspace interface for companies, contacts, vendors, products, pricing, purchasing and related CRM/ERP records.</td><td><a class="link-btn" href="${DIRECTORY_URL}" target="_blank" rel="noopener">Open</a></td></tr>
