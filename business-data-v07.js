...
// Supabase is the live operational source of truth; Google Workspace remains a reporting, document and reference layer.
(function(){
  ...
  function pricingHTML(){
    ...
    return `<div class="v07-head"><div><p class="eyebrow">COMMERCIAL CONTROL</p><h2>Pricing Configurator</h2><p class="muted">Manage service pricing, product/material costs, labor standards and pricing rules from one place.</p></div><div class="v07-actions">${a(MASTER,'Open Master Database',true)}${a(OPS,'Open TTT Operations Drive')}</div></div>
      <div class="v07-source"><div><strong>Supabase is the live pricing and inventory source of truth</strong><p>The OS uses the same Services, Products, Labor Rates and Pricing Rules structure as the Master Database. Prices can be filled in progressively without hard-coding them into the job form.</p></div><span class="badge">Google-linked foundation</span></div>
