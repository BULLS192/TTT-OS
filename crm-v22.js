// TTT OS CRM v2.2 — management dashboard, compact filters and operational sales signals.
(function(){
  'use strict';
  ...
  var data={loaded:false,loading:false,companies:[],contacts:[],leads:[],opportunities:[],activities:[],quotes:[],quote_lines:[],discount_codes:[],invoices:[],jobs:[],documents:[],customers:[],vehicles:[],personnel:[]};
  ...
  function injectStyles(){
    ...
    s.textContent=`
      ...
      .crm-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin:14px 0}.crm-kpi{background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:13px}.crm-kpi span{display:block;color:#64748b;font-size:10px;text-transform:uppercase;letter-spacing:.06em}.crm-kpi strong{display:block;font-size:21px;margin-top:4px}.crm-kpi small{color:#64748b}.crm-dashboard-grid{display:grid;grid-template-columns:1.35fr 1fr;gap:14px}.crm-chart{display:grid;gap:10px}.crm-chart-row{display:grid;grid-template-columns:110px 1fr 88px;gap:10px;align-items:center;font-size:12px}.crm-chart-track{height:12px;background:#edf2f7;border-radius:999px;overflow:hidden}.crm-chart-bar{height:100%;background:#1d4ed8;border-radius:999px;min-width:2px}.crm-chart-label{font-weight:700;color:#334155}.crm-chart-value{text-align:right;color:#64748b}.crm-dashboard-section{margin-top:14px}.crm-trend{display:grid;grid-template-columns:repeat(6,minmax(64px,1fr));gap:8px;align-items:end;min-height:190px;padding:14px 4px 0}.crm-trend-col{height:160px;display:flex;flex-direction:column;justify-content:flex-end;align-items:stretch;gap:5px}.crm-trend-bar-wrap{height:115px;display:flex;align-items:flex-end;justify-content:center}.crm-trend-bar{width:min(46px,75%);min-height:3px;background:#1d4ed8;border-radius:7px 7px 3px 3px}.crm-trend-col strong{font-size:11px;text-align:center}.crm-trend-col small{font-size:9px;color:#64748b;text-align:center}.crm-metric-positive{color:#1f7a4c}.crm-metric-negative{color:#a63b32}.crm-chart-note{font-size:10px;color:#7a8798;margin-top:6px}.crm-stage-pills{display:flex;gap:8px;flex-wrap:wrap;margin:12px 0}.crm-stage-pill{border:1px solid #dfe6ef;background:#fff;border-radius:10px;padding:9px 11px;min-width:112px}.crm-stage-pill span{display:block;color:#64748b;font-size:10px;text-transform:uppercase}.crm-stage-pill strong{display:block;margin-top:2px}.crm-stage-pill small{color:#64748b}
      ...
      .quote-editor-lines{display:grid;gap:8px;margin:12px 0}.quote-editor-line{display:grid;grid-template-columns:minmax(180px,2fr) 70px 105px 85px 90px 100px 34px;gap:7px;align-items:end;padding:10px;border:1px solid #e2e8f0;border-radius:10px;background:#fff}.quote-editor-line label{font-size:10px;font-weight:750;color:#64748b}.quote-editor-line input,.quote-editor-line select{width:100%;box-sizing:border-box;margin-top:4px;border:1px solid #d6deea;border-radius:8px;padding:8px;font:inherit}.quote-line-net{padding:8px 2px;font-size:12px;text-align:right}.quote-remove-line{height:35px;border:1px solid #e2e8f0;background:#fff;border-radius:8px;cursor:pointer}.quote-total-strip{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:7px;margin:12px 0}.quote-total-strip>div{background:#f8fafc;border:1px solid #e7ecf2;border-radius:9px;padding:9px}.quote-total-strip span,.quote-total-strip strong{display:block}.quote-total-strip span{font-size:9px;text-transform:uppercase;color:#748297;font-weight:800}.quote-total-strip strong{margin-top:3px;font-size:14px}.quote-code-status{font-size:10px;color:#64748b;margin-top:5px}.quote-code-status.good{color:#277047}.quote-code-status.bad{color:#b42318}@media(max-width:780px){.quote-editor-line{grid-template-columns:1fr 1fr}.quote-editor-line .quote-desc{grid-column:1/-1}.quote-total-strip{grid-template-columns:1fr 1fr}.quote-remove-line{justify-self:end}}
      .crm-vehicle-other{margin-top:6px}.crm-related-work-picker{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:9px;align-items:end;margin-top:12px}.crm-related-job{border:1px solid #e1e7ef;border-radius:11px;padding:12px;background:#fbfcfe}.crm-related-job+.crm-related-job{margin-top:9px}.crm-related-job-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.crm-related-job-head small{display:block;color:#7a8799;margin-top:3px}.crm-related-children{display:grid;gap:6px;margin-top:9px;padding-top:9px;border-top:1px solid #edf1f5}.crm-related-child{display:flex;align-items:center;justify-content:space-between;gap:10px;background:#fff;border:1px solid #edf1f5;border-radius:8px;padding:8px 9px}.crm-related-child strong,.crm-related-child small{display:block}.crm-related-child small{color:#7b8798;margin-top:2px}.crm-related-kind{font-size:9px;font-weight:850;letter-spacing:.06em;text-transform:uppercase;color:#68809e}.crm-unlinked-note{font-size:11px;color:#7b8798;margin-top:8px}
      @media(max-width:1180px){.crm-kpis{grid-template-columns:repeat(3,1fr)}}@media(max-width:900px){.crm-form-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.crm-span-4{grid-column:span 2}.crm-dashboard-grid{grid-template-columns:1fr}.crm-chart-row{grid-template-columns:95px 1fr 78px}}@media(max-width:620px){.crm-kpis,.crm-form-grid,.crm-detail-grid{grid-template-columns:1fr}.crm-filters{display:grid;grid-template-columns:1fr 1fr;overflow:visible}.crm-filters input{grid-column:1/-1;min-width:0}.crm-filters input,.crm-filters select,.crm-filters .btn{width:100%;min-width:0}.crm-trend{grid-template-columns:repeat(3,1fr);min-height:auto}.crm-trend-col{height:135px}.crm-span-2,.crm-span-4{grid-column:span 1}.crm-chart-row{grid-template-columns:82px 1fr 68px}.crm-detail{width:100vw}.crm-detail-meta{grid-template-columns:1fr}.crm-activity-form{grid-template-columns:1fr}.crm-activity-form textarea,.crm-activity-form button{grid-column:1}.crm-modal-backdrop{padding:4vh 8px 12px}.crm-related-work-picker{grid-template-columns:1fr}.crm-related-job-head,.crm-related-child{align-items:flex-start;flex-direction:column}}
    `;
  ...
  async function load(force){
    ...
    var specs=[
      ...
      ['quotes','id,opportunity_id,customer_id,company_id,contact_id,job_id,status,quote_date,expires_at,subtotal,discount_total,discount_type,discount_value,discount_code_id,discount_code,discount_note,tax_total,total,deposit_required,terms,notes,metadata,google_doc_url,pdf_drive_file_id,sent_at,approved_at,declined_at,updated_at'],
      ...
      ['jobs','id,work_order_id,customer_id,vehicle_id,status,appointment_local,estimate_total,opportunity_id,primary_quote_id,primary_invoice_id,source_json,created_at,updated_at'],
      ...
      ['quote_lines','id,quote_id,product_id,line_type,description,quantity,unit_cost,list_unit_price,unit_price,discount_type,discount_value,discount_amount,labor_hours,taxable,line_total,sort_order,metadata,updated_at'],
      ['discount_codes','id,code,name,discount_type,discount_value,campaign_name,valid_from,valid_until,minimum_subtotal,max_uses,times_used,active,metadata,updated_at'],
  ...
  function renderDashboard(){
    var allOpps=data.opportunities.slice(),open=allOpps.filter(openOpp);
    var won=allOpps.filter(function(o){return String(o.stage||'').toLowerCase()==='closed_won';});
    var lost=allOpps.filter(function(o){return String(o.stage||'').toLowerCase()==='closed_loss';});
    var closed=won.concat(lost),openPipeline=sum(open,'estimated_value');
    var weighted=open.reduce(function(s,o){return s+Number(o.estimated_value||0)*(Number(o.probability_pct==null?stageInfo(o.stage).pct:o.probability_pct)/100);},0);
    var wonValue=sum(won,'estimated_value'),lostValue=sum(lost,'estimated_value'),winRate=closed.length?(won.length/closed.length*100):0;
    var avgWon=won.length?wonValue/won.length:0;
    var now=new Date(),monthStart=new Date(now.getFullYear(),now.getMonth(),1),quarterStart=new Date(now.getFullYear(),Math.floor(now.getMonth()/3)*3,1);
    var createdThisMonth=allOpps.filter(function(o){return new Date(o.created_at)>=monthStart;}).length;
    var createdThisQuarter=allOpps.filter(function(o){return new Date(o.created_at)>=quarterStart;}).length;
    var staleCutoff=new Date(now.getTime()-14*86400000);
    var staleOpen=open.filter(function(o){var d=new Date(o.updated_at||o.created_at);return !isNaN(d.getTime())&&d<staleCutoff;});
    var monthEnd=new Date(now.getFullYear(),now.getMonth()+1,1);
    var closingThisMonth=open.filter(function(o){if(!o.expected_close_date)return false;var d=new Date(o.expected_close_date+'T12:00:00');return d>=monthStart&&d<monthEnd;});
    var closingValue=sum(closingThisMonth,'estimated_value');
    var kpis=[
      ['Open pipeline',cash(openPipeline),open.length+' open opportunities',''],
      ['Weighted pipeline',cash(weighted),'Probability adjusted',''],
      ['Total won',cash(wonValue),won.length+' won','crm-metric-positive'],
      ['Total lost',cash(lostValue),lost.length+' lost','crm-metric-negative'],
      ['Win rate',pct(winRate),won.length+' of '+closed.length+' closed',''],
      ['Average won deal',cash(avgWon),'Closed-won average',''],
      ['Opps this month',createdThisMonth,now.toLocaleDateString([],{month:'long'}),''],
      ['Opps this quarter',createdThisQuarter,'Q'+(Math.floor(now.getMonth()/3)+1)+' '+now.getFullYear(),''],
      ['Closing this month',closingThisMonth.length,cash(closingValue)+' expected',''],
      ['Stale open deals',staleOpen.length,'No update in 14+ days',staleOpen.length?'crm-metric-negative':'crm-metric-positive']
    ];
    var stageValues=STAGE_ORDER.map(function(s){var rows=allOpps.filter(function(o){return String(o.stage||'').toLowerCase()===s;});return {label:STAGES[s].label,count:rows.length,value:sum(rows,'estimated_value')};});
    ...
    var services={};allOpps.forEach(function(o){var s=String(o.related_service||o.category||'Unspecified').trim()||'Unspecified';if(!services[s])services[s]={count:0,value:0};services[s].count++;services[s].value+=Number(o.estimated_value||0);});
    var serviceRows=Object.keys(services).map(function(k){return {label:k,count:services[k].count,value:services[k].value};}).sort(function(a,b){return b.value-a.value;}).slice(0,8);
    var maxService=Math.max.apply(null,serviceRows.map(function(x){return x.value;}));if(!isFinite(maxService)||maxService<=0)maxService=1;
    var serviceChart=serviceRows.map(function(x){return '<div class="crm-chart-row"><span class="crm-chart-label">'+html(x.label)+'</span><div class="crm-chart-track"><div class="crm-chart-bar" style="width:'+Math.max(2,Math.round(x.value/maxService*100))+'%"></div></div><span class="crm-chart-value">'+x.count+' · '+cash(x.value)+'</span></div>';}).join('')||'<div class="crm-mini-empty">No service mix yet.</div>';

    var monthRows=[];
    for(var m=5;m>=0;m--){var d=new Date(now.getFullYear(),now.getMonth()-m,1),next=new Date(d.getFullYear(),d.getMonth()+1,1);var rows=allOpps.filter(function(o){var x=new Date(o.created_at);return x>=d&&x<next;});monthRows.push({label:d.toLocaleDateString([],{month:'short'}),count:rows.length,value:sum(rows,'estimated_value')});}
    var maxMonth=Math.max.apply(null,monthRows.map(function(x){return x.count;}));if(!isFinite(maxMonth)||maxMonth<=0)maxMonth=1;
    var monthChart='<div class="crm-trend">'+monthRows.map(function(x){return '<div class="crm-trend-col"><div class="crm-trend-bar-wrap"><div class="crm-trend-bar" style="height:'+Math.max(3,Math.round(x.count/maxMonth*100))+'%"></div></div><strong>'+x.count+'</strong><small>'+html(x.label)+'<br>'+cash(x.value)+'</small></div>';}).join('')+'</div>';

    var quarters=[];
    for(var q=3;q>=0;q--){var qIndex=Math.floor(now.getMonth()/3)-q,qYear=now.getFullYear();while(qIndex<0){qIndex+=4;qYear--;}var start=new Date(qYear,qIndex*3,1),end=new Date(qYear,qIndex*3+3,1);var rows=allOpps.filter(function(o){var x=new Date(o.created_at);return x>=start&&x<end;});quarters.push({label:'Q'+(qIndex+1)+' '+qYear,count:rows.length,value:sum(rows,'estimated_value')});}
    var maxQuarter=Math.max.apply(null,quarters.map(function(x){return x.value;}));if(!isFinite(maxQuarter)||maxQuarter<=0)maxQuarter=1;
    var quarterChart=quarters.map(function(x){return '<div class="crm-chart-row"><span class="crm-chart-label">'+html(x.label)+'</span><div class="crm-chart-track"><div class="crm-chart-bar" style="width:'+Math.max(2,Math.round(x.value/maxQuarter*100))+'%"></div></div><span class="crm-chart-value">'+x.count+' · '+cash(x.value)+'</span></div>';}).join('');

    var staleList=staleOpen.slice().sort(function(a,b){return new Date(a.updated_at||a.created_at)-new Date(b.updated_at||b.created_at);}).slice(0,6).map(function(o){var days=Math.max(0,Math.floor((now-new Date(o.updated_at||o.created_at))/86400000));return '<div class="crm-link-item" data-crm-record="opportunity" data-crm-id="'+attr(o.id)+'"><div><strong>'+html(o.title||o.id)+'</strong><small>'+html(personName(o.owner_person_id))+' · '+days+' days since update</small></div><span>'+cash(o.estimated_value)+'</span></div>';}).join('')||'<div class="crm-mini-empty">No stale open opportunities.</div>';
    ...
    document.getElementById('crmDashboard').innerHTML=
      '<div class="crm-kpis">'+kpis.map(function(x){return '<div class="crm-kpi"><span>'+html(x[0])+'</span><strong class="'+x[3]+'">'+html(x[1])+'</strong><small>'+html(x[2])+'</small></div>';}).join('')+'</div>'+
      '<div class="crm-dashboard-grid"><article class="panel"><div class="panel-head"><div><h3>Pipeline by stage</h3><p class="muted">Opportunity count and value across the sales funnel.</p></div></div><div class="crm-chart">'+stageChart+'</div></article>'+
      '<article class="panel"><div class="panel-head"><div><h3>Opportunities by service</h3><p class="muted">Which services are generating pipeline.</p></div></div><div class="crm-chart">'+serviceChart+'</div></article></div>'+
      '<div class="crm-dashboard-grid crm-dashboard-section"><article class="panel"><div class="panel-head"><div><h3>Opportunities by month</h3><p class="muted">New opportunities created over the last six months.</p></div></div>'+monthChart+'</article>'+
      '<article class="panel"><div class="panel-head"><div><h3>Quarterly opportunity trend</h3><p class="muted">Count and pipeline created across the last four quarters.</p></div></div><div class="crm-chart">'+quarterChart+'</div></article></div>'+
      '<div class="grid two top-gap"><article class="panel"><div class="panel-head"><div><h3>Won vs. lost</h3><p class="muted">Closed opportunity performance.</p></div></div><div class="crm-detail-meta">'+meta('Won',won.length+' · '+cash(wonValue))+meta('Lost',lost.length+' · '+cash(lostValue))+meta('Win rate',pct(winRate))+meta('Avg. won deal',cash(avgWon))+'</div></article>'+
      '<article class="panel"><div class="panel-head"><div><h3>Needs sales attention</h3><p class="muted">Open opportunities with no update in 14+ days.</p></div><span class="badge">'+staleOpen.length+'</span></div><div class="crm-link-list">'+staleList+'</div></article></div>'+
      '<article class="panel top-gap"><div class="panel-head"><h3>Recent activity</h3><span class="badge">'+data.activities.length+'</span></div><div class="crm-link-list">'+recent+'</div></article>';
  }
  ...
  function crmVehicleCatalog(){
    try{if(typeof VEHICLE_CATALOG==='object'&&VEHICLE_CATALOG)return VEHICLE_CATALOG;}catch(e){}
    return {};
  }
  function crmVehicleYears(){
    var years=[],max=new Date().getFullYear()+1;
    for(var y=max;y>=1981;y--)years.push(String(y));
    return years;
  }
  function selectorValue(selectId,otherId){
    var sel=document.getElementById(selectId),other=document.getElementById(otherId);
    if(!sel)return '';
    return sel.value==='__other'?String(other?.value||'').trim():String(sel.value||'').trim();
  }
  function setSelectorStoredValue(sel,other,value){
    value=String(value||'').trim();if(!sel)return;
    var match=[...sel.options].find(function(x){return String(x.value).toLowerCase()===value.toLowerCase();});
    if(match){sel.value=match.value;if(other){other.hidden=true;other.value='';}return;}
    if(value){sel.value='__other';if(other){other.hidden=false;other.value=value;}}else{sel.value='';if(other){other.hidden=true;other.value='';}}
  }
  function bindVehicleSelectors(prefix,vehicle){
    vehicle=vehicle||{};
    var year=document.getElementById(prefix+'Year'),make=document.getElementById(prefix+'Make'),model=document.getElementById(prefix+'Model');
    var yearOther=document.getElementById(prefix+'YearOther'),makeOther=document.getElementById(prefix+'MakeOther'),modelOther=document.getElementById(prefix+'ModelOther');
    if(!year||!make||!model)return;
    var catalog=crmVehicleCatalog();
    year.innerHTML='<option value="">Select year</option>'+crmVehicleYears().map(function(x){return '<option value="'+attr(x)+'">'+html(x)+'</option>';}).join('')+'<option value="__other">Other / Not listed</option>';
    make.innerHTML='<option value="">Select make</option>'+Object.keys(catalog).sort().map(function(x){return '<option value="'+attr(x)+'">'+html(x)+'</option>';}).join('')+'<option value="__other">Other / Not listed</option>';
    function fillModels(stored){
      var makeValue=selectorValue(prefix+'Make',prefix+'MakeOther');
      var models=Array.isArray(catalog[makeValue])?catalog[makeValue]:[];
      model.innerHTML='<option value="">Select model</option>'+models.map(function(x){return '<option value="'+attr(x)+'">'+html(x)+'</option>';}).join('')+'<option value="__other">Other / Not listed</option>';
      setSelectorStoredValue(model,modelOther,stored||'');
    }
    setSelectorStoredValue(year,yearOther,vehicle.year||'');
    setSelectorStoredValue(make,makeOther,vehicle.make||'');
    fillModels(vehicle.model||'');
    year.onchange=function(){var other=year.value==='__other';yearOther.hidden=!other;if(!other)yearOther.value='';if(other)setTimeout(function(){yearOther.focus();},0);};
    make.onchange=function(){var other=make.value==='__other';makeOther.hidden=!other;if(!other)makeOther.value='';fillModels('');if(other)setTimeout(function(){makeOther.focus();},0);};
    makeOther.oninput=function(){fillModels('');};
    model.onchange=function(){var other=model.value==='__other';modelOther.hidden=!other;if(!other)modelOther.value='';if(other)setTimeout(function(){modelOther.focus();},0);};
  }
  function changeOrdersForJob(job){
    if(Array.isArray(job?.source_json?.changeOrders))return job.source_json.changeOrders;
    try{var local=(typeof db!=='undefined'&&Array.isArray(db?.jobs))?db.jobs.find(function(x){return x.id===job?.id;}):null;return Array.isArray(local?.changeOrders)?local.changeOrders:[];}catch(e){return [];}
  }
  function relatedWorkOptionHTML(o){
    var rows=[];
    data.jobs.filter(function(j){return !j.opportunity_id;}).forEach(function(j){
      rows.push({value:'job::'+j.id,label:'Job '+j.id+' · '+(j.status||'')});
      if(j.work_order_id)rows.push({value:'workorder::'+j.id,label:'Work Order '+j.work_order_id+' · Job '+j.id});
      changeOrdersForJob(j).forEach(function(co){rows.push({value:'changeorder::'+j.id+'::'+co.id,label:'Change Order '+co.id+' · Job '+j.id+' · '+(co.status||'')});});
    });
    return '<option value="">Select Job, Work Order or Change Order…</option>'+rows.map(function(r){return '<option value="'+attr(r.value)+'">'+html(r.label)+'</option>';}).join('');
  }
  function relatedJobHTML(j,o){
    var changes=changeOrdersForJob(j),children='';
    if(j.work_order_id)children+='<div class="crm-related-child"><div><span class="crm-related-kind">Work Order</span><strong>'+html(j.work_order_id)+'</strong><small>Owned by '+html(j.id)+'</small></div><button class="btn secondary compact" data-open-job="'+attr(j.id)+'">Open</button></div>';
    children+=changes.map(function(co){return '<div class="crm-related-child"><div><span class="crm-related-kind">Change Order</span><strong>'+html(co.id||'Change Order')+'</strong><small>'+html(co.status||'Draft')+' · '+cash(co.totalDelta||0)+(co.description?' · '+html(co.description):'')+'</small></div><button class="btn secondary compact" data-open-job="'+attr(j.id)+'">Open job</button></div>';}).join('');
    if(!children)children='<div class="crm-mini-empty">No Work Order or Change Orders yet for this Job.</div>';
    return '<div class="crm-related-job"><div class="crm-related-job-head"><div><span class="crm-related-kind">Job</span><strong>'+html(j.id)+'</strong><small>'+html(j.status||'Job')+(j.appointment_local?' · '+when(j.appointment_local):' · No appointment')+(o.won_job_id===j.id?' · Primary / won job':'')+'</small></div><div class="crm-inline-actions"><button class="btn secondary compact" data-open-job="'+attr(j.id)+'">Open Job</button><button class="btn danger compact" data-unlink-job="'+attr(j.id)+'">Unlink</button></div></div><div class="crm-related-children">'+children+'</div></div>';
  }
  ...
  function opportunityRelations(o){
    ...
    var workOrders=jobs.filter(function(j){return !!j.work_order_id;}).map(function(j){return {id:j.work_order_id,job_id:j.id};});
    var changeOrders=[];jobs.forEach(function(j){changeOrdersForJob(j).forEach(function(co){changeOrders.push(Object.assign({job_id:j.id,work_order_id:j.work_order_id||null},co));});});
    ...
    return {quotes:quotes,jobs:jobs,workOrders:workOrders,changeOrders:changeOrders,invoices:invoices,documents:docs};
  }
  ...
  function opportunityDetail(id){
    ...
    return detailHead('OPPORTUNITY',o.title,companyName(o.company_id)+' · '+contactName(o.contact_id))+'<div class="crm-detail-body">'+
      ...
      '<label>Vehicle year<select id="crmOppVehicleYear"></select><input id="crmOppVehicleYearOther" class="crm-vehicle-other" placeholder="Enter year" hidden></label>'+
      '<label>Vehicle make<select id="crmOppVehicleMake"></select><input id="crmOppVehicleMakeOther" class="crm-vehicle-other" placeholder="Enter make" hidden></label>'+
      '<label>Vehicle model<select id="crmOppVehicleModel"></select><input id="crmOppVehicleModelOther" class="crm-vehicle-other" placeholder="Enter model" hidden></label><label>VIN<input id="crmOppVehicleVin" maxlength="17" value="'+attr(vehicle.vin||'')+'"></label>'+
      ...
      '<article class="crm-detail-card"><div class="panel-head"><div><h4>Related Work</h4><p class="muted">Link an existing Job, Work Order or Change Order. Work Orders and Change Orders remain owned by their Job.</p></div><span class="badge">'+rels.jobs.length+' job'+(rels.jobs.length===1?'':'s')+' · '+rels.workOrders.length+' WO · '+rels.changeOrders.length+' CO</span></div>'+
      '<div id="crmRelatedWorkList">'+(rels.jobs.map(function(j){return relatedJobHTML(j,o);}).join('')||'<div class="crm-mini-empty">No operational work linked to this opportunity yet.</div>')+'</div>'+
      '<div class="crm-related-work-picker"><label>Link existing work<select id="crmRelatedWorkSelect">'+relatedWorkOptionHTML(o)+'</select></label><button class="btn secondary" id="crmLinkRelatedWork" type="button">Link</button></div>'+
      '<p class="crm-unlinked-note">Selecting a Work Order or Change Order links its owning Job, preserving one canonical relationship.</p></article>'+
  ...
  function quoteMini(q){
    ...
    if(status==='draft')actions='<button class="btn secondary compact" data-edit-quote="'+attr(q.id)+'">Edit pricing</button><button class="btn secondary compact" data-quote-status="sent" data-quote-id="'+attr(q.id)+'">Mark sent</button><button class="btn primary compact" data-quote-status="approved" data-quote-id="'+attr(q.id)+'">Approve</button>';
    else if(status==='sent')actions='<button class="btn secondary compact" data-edit-quote="'+attr(q.id)+'">Revise pricing</button><button class="btn primary compact" data-quote-status="approved" data-quote-id="'+attr(q.id)+'">Approve</button><button class="btn danger compact" data-quote-status="declined" data-quote-id="'+attr(q.id)+'">Decline</button>';
  ...
  function bindDetailActions(type,id){
    ...
    if(type==='opportunity'){var opp=data.opportunities.find(function(x){return x.id===id;});bindVehicleSelectors('crmOppVehicle',opp?.metadata?.vehicle||{});}
    document.getElementById('crmLinkRelatedWork')?.addEventListener('click',function(){linkRelatedWork(id);});
    document.querySelectorAll('[data-unlink-job]').forEach(function(b){b.onclick=function(){unlinkRelatedJob(id,b.dataset.unlinkJob);};});
    ...
    document.querySelectorAll('[data-edit-quote]').forEach(function(b){b.onclick=function(){openQuoteEditor(b.dataset.editQuote);};});
  ...
  async function linkRelatedWork(opportunityId){
    var cloud=window.TTTCloud,sel=document.getElementById('crmRelatedWorkSelect');if(!cloud?.ready||!sel?.value)return toastSafe('Choose a Job, Work Order or Change Order to link.');
    var parts=String(sel.value).split('::'),kind=parts[0],jobId=parts[1],recordId=parts[2]||null;
    var j=data.jobs.find(function(x){return x.id===jobId;});if(!j)return toastSafe('The owning Job could not be found.');
    if(j.opportunity_id&&j.opportunity_id!==opportunityId)return toastSafe('That Job is already linked to another Opportunity.');
    var source=Object.assign({},j.source_json||{});source.id=source.id||j.id;source.opportunityId=opportunityId;
    var update=await cloud.client.from('jobs').update({opportunity_id:opportunityId,source_json:source,last_synced_by:cloud.userId,updated_at:new Date().toISOString()}).eq('organization_id',cloud.organizationId).eq('id',jobId).select('id').single();
    if(update.error)return toastSafe('Related work could not be linked: '+update.error.message);
    await cloud.audit?.('opportunity',opportunityId,'related_work_linked',{relationship_type:kind,job_id:jobId,related_record_id:recordId||j.work_order_id||jobId});
    data.loaded=false;await load(true);toastSafe((kind==='changeorder'?'Change Order':kind==='workorder'?'Work Order':'Job')+' linked through Job '+jobId+'.');
  }

  async function unlinkRelatedJob(opportunityId,jobId){
    var cloud=window.TTTCloud,j=data.jobs.find(function(x){return x.id===jobId;}),o=data.opportunities.find(function(x){return x.id===opportunityId;});if(!cloud?.ready||!j)return;
    if(!window.confirm('Unlink Job '+jobId+' and its Work Order / Change Orders from this Opportunity?'))return;
    var source=Object.assign({},j.source_json||{});source.id=source.id||j.id;source.opportunityId=null;
    var update=await cloud.client.from('jobs').update({opportunity_id:null,source_json:source,last_synced_by:cloud.userId,updated_at:new Date().toISOString()}).eq('organization_id',cloud.organizationId).eq('id',jobId).select('id').single();
    if(update.error)return toastSafe('Job could not be unlinked: '+update.error.message);
    if(o?.won_job_id===jobId){
      var oppUpdate=await cloud.client.from('opportunities').update({won_job_id:null,updated_by:cloud.userId}).eq('organization_id',cloud.organizationId).eq('id',opportunityId);
      if(oppUpdate.error)return toastSafe('Job unlinked, but the primary Opportunity link needs attention: '+oppUpdate.error.message);
    }
    await cloud.audit?.('opportunity',opportunityId,'related_work_unlinked',{job_id:jobId});
    data.loaded=false;await load(true);toastSafe('Job '+jobId+' and its downstream work were unlinked.');
  }
  ...
  function quoteLinesFor(id){return data.quote_lines.filter(function(x){return x.quote_id===id&&!x.archived_at;}).sort(function(a,b){return Number(a.sort_order||0)-Number(b.sort_order||0);});}
  function discountCalc(base,type,value){base=Math.max(0,Number(base||0));value=Math.max(0,Number(value||0));return type==='percent'?Math.min(base,base*value/100):Math.min(base,value);}
  function activeDiscountCode(code,base){
    code=String(code||'').trim().toUpperCase();if(!code)return null;
    var nowDate=new Date();
    return data.discount_codes.find(function(x){
      if(String(x.code||'').toUpperCase()!==code||x.active===false||x.archived_at)return false;
      if(x.valid_from&&new Date(x.valid_from)>nowDate)return false;
      if(x.valid_until&&new Date(x.valid_until)<nowDate)return false;
      if(Number(x.minimum_subtotal||0)>Number(base||0))return false;
      if(x.max_uses!=null&&Number(x.times_used||0)>=Number(x.max_uses))return false;
      return true;
    })||null;
  }
  function quoteEditorLine(line,index){
    var list=line.list_unit_price==null?Number(line.unit_price||0):Number(line.list_unit_price||0);
    return '<div class="quote-editor-line" data-quote-line-id="'+attr(line.id||'')+'" data-list-price="'+attr(list)+'">'+
      '<label class="quote-desc">Description<input data-q="description" value="'+attr(line.description||'')+'" required></label>'+
      '<label>Qty<input data-q="quantity" type="number" min="0" step=".01" value="'+attr(line.quantity||1)+'"></label>'+
      '<label>Sales price<input data-q="unit_price" type="number" min="0" step=".01" value="'+attr(Number(line.unit_price||0).toFixed(2))+'"></label>'+
      '<label>Discount<select data-q="discount_type"><option value="percent" '+(line.discount_type!=='amount'?'selected':'')+'>%</option><option value="amount" '+(line.discount_type==='amount'?'selected':'')+'>$</option></select></label>'+
      '<label>Discount value<input data-q="discount_value" type="number" min="0" step=".01" value="'+attr(Number(line.discount_value||0))+'"></label>'+
      '<div class="quote-line-net"><small>Net</small><strong data-q-net>$0.00</strong></div>'+
      '<button type="button" class="quote-remove-line" title="Remove line">×</button></div>';
  }
  function readQuoteEditor(form,q){
    var rows=[...form.querySelectorAll('.quote-editor-line')].map(function(r,i){
      var quantity=Math.max(0,Number(r.querySelector('[data-q="quantity"]').value||0));
      var unit=Math.max(0,Number(r.querySelector('[data-q="unit_price"]').value||0));
      var gross=quantity*unit,type=r.querySelector('[data-q="discount_type"]').value,value=Math.max(0,Number(r.querySelector('[data-q="discount_value"]').value||0));
      var disc=discountCalc(gross,type,value);
      return {id:r.dataset.quoteLineId||idToken('QLN-'),description:r.querySelector('[data-q="description"]').value.trim()||'Quote line',quantity:quantity,unit_price:unit,list_unit_price:Number(r.dataset.listPrice||unit),discount_type:type,discount_value:value,discount_amount:disc,line_total:Math.max(0,gross-disc),sort_order:i+1};
    });
    var gross=rows.reduce(function(s,x){return s+x.quantity*x.unit_price;},0),lineDisc=rows.reduce(function(s,x){return s+x.discount_amount;},0),afterLines=Math.max(0,gross-lineDisc);
    var overallType=form.elements.overall_discount_type.value,overallValue=Math.max(0,Number(form.elements.overall_discount_value.value||0)),overallDisc=discountCalc(afterLines,overallType,overallValue);
    var afterOverall=Math.max(0,afterLines-overallDisc),codeText=String(form.elements.discount_code.value||'').trim().toUpperCase(),code=activeDiscountCode(codeText,afterOverall),codeDisc=code?discountCalc(afterOverall,code.discount_type,code.discount_value):0;
    var tax=Math.max(0,Number(form.elements.tax_total.value||0)),total=Math.max(0,afterOverall-codeDisc+tax);
    return {rows,gross,lineDisc,overallType,overallValue,overallDisc,codeText,code,codeDisc,tax,total,discountTotal:lineDisc+overallDisc+codeDisc};
  }
  function updateQuoteEditor(form,q){
    var calc=readQuoteEditor(form,q);
    form.querySelectorAll('.quote-editor-line').forEach(function(r,i){var out=r.querySelector('[data-q-net]');if(out)out.textContent=new Intl.NumberFormat('en-US',{style:'currency',currency:'USD'}).format(calc.rows[i]?.line_total||0);});
    var set=function(id,v){var el=form.querySelector(id);if(el)el.textContent=new Intl.NumberFormat('en-US',{style:'currency',currency:'USD'}).format(v||0);};
    set('[data-qt-gross]',calc.gross);set('[data-qt-line-discount]',calc.lineDisc);set('[data-qt-discount]',calc.overallDisc+calc.codeDisc);set('[data-qt-tax]',calc.tax);set('[data-qt-total]',calc.total);
    var status=form.querySelector('.quote-code-status');
    if(status){if(!calc.codeText){status.textContent='Optional — campaign codes can be managed later.';status.className='quote-code-status';}else if(calc.code){status.textContent='✓ '+(calc.code.name||calc.code.code)+' applied'+(calc.code.campaign_name?' · '+calc.code.campaign_name:'');status.className='quote-code-status good';}else{status.textContent='Code is invalid, expired, over its usage limit, or does not meet the minimum.';status.className='quote-code-status bad';}}
    return calc;
  }
  function openQuoteEditor(quoteId){
    var q=data.quotes.find(function(x){return x.id===quoteId;});if(!q)return;
    if(!['draft','sent'].includes(String(q.status||'').toLowerCase()))return toastSafe('Approved or closed quotes are protected. Create a Change Order for later scope changes.');
    var lines=quoteLinesFor(quoteId);if(!lines.length)lines=[{description:'Service',quantity:1,unit_price:Number(q.subtotal||q.total||0),list_unit_price:Number(q.subtotal||q.total||0),discount_type:'percent',discount_value:0}];
    openCreateModal('Edit '+q.id,'Adjust selling prices, line discounts or the overall quotation before approval.',
      '<form id="crmQuoteEditForm"><div class="panel"><div class="panel-head"><div><h4>Quote lines</h4><p class="muted">Sales price can be marked up or down directly. The original list/base price is retained for reference.</p></div><button type="button" class="btn secondary compact" id="crmAddQuoteLine">+ Line</button></div><div class="quote-editor-lines" id="crmQuoteEditLines">'+lines.map(quoteEditorLine).join('')+'</div></div>'+
      '<div class="crm-detail-grid"><label>Overall discount type<select name="overall_discount_type"><option value="amount" '+(q.discount_type!=='percent'?'selected':'')+'>Dollar amount</option><option value="percent" '+(q.discount_type==='percent'?'selected':'')+'>Percent</option></select></label><label>Overall discount value<input name="overall_discount_value" type="number" min="0" step=".01" value="'+attr(Number(q.discount_value||0))+'"></label>'+
      '<label>Campaign / coupon code<input name="discount_code" value="'+attr(q.discount_code||'')+'" placeholder="Optional code"></label><label>Tax amount<input name="tax_total" type="number" min="0" step=".01" value="'+attr(Number(q.tax_total||0))+'"></label>'+
      '<label>Deposit required<input name="deposit_required" type="number" min="0" step=".01" value="'+attr(Number(q.deposit_required||0))+'"></label><label>Expires<input name="expires_at" type="date" value="'+attr(q.expires_at||'')+'"></label>'+
      '<label class="crm-span-2">Discount / pricing note<textarea name="discount_note" placeholder="Reason for negotiated pricing, manager approval, promotion, etc.">'+html(q.discount_note||'')+'</textarea></label>'+
      '<label class="crm-span-2">Terms<textarea name="terms">'+html(q.terms||'')+'</textarea></label><label class="crm-span-2">Notes<textarea name="notes">'+html(q.notes||'')+'</textarea></label></div>'+
      '<div class="quote-code-status"></div><div class="quote-total-strip"><div><span>Gross</span><strong data-qt-gross>$0</strong></div><div><span>Line discounts</span><strong data-qt-line-discount>$0</strong></div><div><span>Overall / code</span><strong data-qt-discount>$0</strong></div><div><span>Tax</span><strong data-qt-tax>$0</strong></div><div><span>Total</span><strong data-qt-total>$0</strong></div></div>'+
      '<div class="crm-inline-actions"><button class="btn primary" type="submit">Save quotation pricing</button></div></form>');
    var form=document.getElementById('crmQuoteEditForm'),box=document.getElementById('crmQuoteEditLines');
    function bindLine(r){r.querySelectorAll('input,select').forEach(function(x){x.addEventListener('input',function(){updateQuoteEditor(form,q);});x.addEventListener('change',function(){updateQuoteEditor(form,q);});});r.querySelector('.quote-remove-line').onclick=function(){r.remove();if(!box.children.length){box.insertAdjacentHTML('beforeend',quoteEditorLine({},0));bindLine(box.lastElementChild);}updateQuoteEditor(form,q);};}
    [...box.children].forEach(bindLine);
    document.getElementById('crmAddQuoteLine').onclick=function(){box.insertAdjacentHTML('beforeend',quoteEditorLine({description:'',quantity:1,unit_price:0,list_unit_price:0,discount_type:'percent',discount_value:0},box.children.length));bindLine(box.lastElementChild);updateQuoteEditor(form,q);};
    form.querySelectorAll('[name="overall_discount_type"],[name="overall_discount_value"],[name="discount_code"],[name="tax_total"]').forEach(function(x){x.addEventListener('input',function(){updateQuoteEditor(form,q);});x.addEventListener('change',function(){updateQuoteEditor(form,q);});});
    form.addEventListener('submit',function(e){saveQuotePricing(e,quoteId);});
    updateQuoteEditor(form,q);
  }
  async function saveQuotePricing(ev,quoteId){
    ev.preventDefault();var cloud=window.TTTCloud,q=data.quotes.find(function(x){return x.id===quoteId;}),form=ev.currentTarget;if(!cloud?.ready||!q)return;
    if(!['draft','sent'].includes(String(q.status||'').toLowerCase()))return toastSafe('This quote is no longer editable.');
    var calc=updateQuoteEditor(form,q);if(calc.codeText&&!calc.code)return toastSafe('Resolve the discount code before saving.');
    try{
      var existing=quoteLinesFor(quoteId),submitted=new Set(calc.rows.map(function(x){return x.id;}));
      var rows=calc.rows.map(function(x){
        var prior=existing.find(function(p){return p.id===x.id;})||{};
        return {organization_id:cloud.organizationId,id:x.id,quote_id:quoteId,product_id:prior.product_id||null,line_type:prior.line_type||'service',description:x.description,quantity:x.quantity,unit_cost:prior.unit_cost??null,list_unit_price:x.list_unit_price,unit_price:x.unit_price,discount_type:x.discount_type,discount_value:x.discount_value,discount_amount:x.discount_amount,labor_hours:prior.labor_hours??null,taxable:prior.taxable!==false,line_total:x.line_total,sort_order:x.sort_order,metadata:prior.metadata||{}};
      });
      var up=await cloud.client.from('quote_lines').upsert(rows,{onConflict:'organization_id,id'});if(up.error)throw up.error;
      for(const prior of existing){if(!submitted.has(prior.id)){var ar=await cloud.client.from('quote_lines').update({archived_at:new Date().toISOString()}).eq('organization_id',cloud.organizationId).eq('id',prior.id);if(ar.error)throw ar.error;}}
      var fd=new FormData(form),metadata=Object.assign({},q.metadata||{},{coupon_discount:calc.codeDisc,last_pricing_revision_at:new Date().toISOString()});
      var patch={subtotal:calc.gross,discount_total:calc.discountTotal,discount_type:calc.overallType,discount_value:calc.overallValue,discount_code_id:calc.code?.id||null,discount_code:calc.code?.code||null,discount_note:String(fd.get('discount_note')||'').trim()||null,tax_total:calc.tax,total:calc.total,deposit_required:Math.max(0,Number(fd.get('deposit_required')||0)),expires_at:String(fd.get('expires_at')||'')||null,terms:String(fd.get('terms')||'').trim()||null,notes:String(fd.get('notes')||'').trim()||null,metadata:metadata,updated_by:cloud.userId};
      var qr=await cloud.client.from('quotes').update(patch).eq('organization_id',cloud.organizationId).eq('id',quoteId);if(qr.error)throw qr.error;
      await cloud.audit?.('quote',quoteId,'quote_pricing_updated',{subtotal:calc.gross,line_discount:calc.lineDisc,overall_discount:calc.overallDisc,coupon_code:calc.code?.code||null,coupon_discount:calc.codeDisc,total:calc.total});
      closeCreateModal();data.loaded=false;await load(true);toastSafe('Quotation pricing updated.');
    }catch(err){console.error(err);toastSafe('Quotation pricing update failed: '+String(err.message||err));}
  }
  ...
  async function createQuote(ev,opportunityId){
    ...
    var line={organization_id:cloud.organizationId,quote_id:out.data.id,line_type:'service',description:String(fd.get('description')||o.related_service||o.title),quantity:1,list_unit_price:subtotal,unit_price:subtotal,discount_type:'percent',discount_value:0,discount_amount:0,line_total:subtotal,sort_order:1};
  ...
  function openJobModal(opportunityId,quoteId){
    ...
    openCreateModal('Create job from approved quote',o.title,
      '<form id="crmJobForm"><div class="crm-detail-grid"><label>Existing vehicle<select name="vehicle_id"><option value="">Create / leave vehicle blank</option>'+vehicles.map(function(v){return '<option value="'+attr(v.id)+'">'+html([v.year,v.make,v.model,v.trim].filter(Boolean).join(' ')||v.vin||v.id)+'</option>';}).join('')+'</select></label><label>Preferred appointment<input name="appointment" type="datetime-local"></label>'+
      '<label>Year<select id="crmJobVehicleYear"></select><input id="crmJobVehicleYearOther" class="crm-vehicle-other" placeholder="Enter year" hidden></label>'+
      '<label>Make<select id="crmJobVehicleMake"></select><input id="crmJobVehicleMakeOther" class="crm-vehicle-other" placeholder="Enter make" hidden></label>'+
      '<label>Model<select id="crmJobVehicleModel"></select><input id="crmJobVehicleModelOther" class="crm-vehicle-other" placeholder="Enter model" hidden></label>'+
    ...
    bindVehicleSelectors('crmJobVehicle',vehicle);
  ...
  async function createJobFromOpportunity(ev,opportunityId,quoteId){
    ...
    try{
      ...
      if(!vehicleId){
        var year=selectorValue('crmJobVehicleYear','crmJobVehicleYearOther'),make=selectorValue('crmJobVehicleMake','crmJobVehicleMakeOther'),model=selectorValue('crmJobVehicleModel','crmJobVehicleModelOther'),vin=String(fd.get('vin')||'').trim().toUpperCase();
  ...
  function subscribeRealtime(){
    ...
    ['companies','contacts','leads','opportunities','activities','quotes','quote_lines','discount_codes','customers','vehicles','invoices','jobs','documents'].forEach(function(table){realtimeChannel.on('postgres_changes',{event:'*',schema:'public',table:table,filter:'organization_id=eq.'+cloud.organizationId},function(){data.loaded=false;if(document.getElementById('crm')?.classList.contains('active'))load(true);});});
