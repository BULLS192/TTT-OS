// TTT OS CRM v2.1 — editable quotation pricing, line discounts and campaign discount-code foundation.
(function(){
  'use strict';
  ...
  function renderDashboard(){
    ...
    document.getElementById('crmDashboard').innerHTML=
      ...
      '<article class="panel"><div class="panel-head"><h3>Recent activity</h3><span class="badge">'+data.activities.length+'</span></div><div class="crm-link-list">'+recent+'</div></article></div>';
  }
