// TTT OS CRM/ERP v1.3 — Supabase-native sales and operations cockpit
(function(){
  'use strict';
  ...
  function inject(){
    ...
    if(main&&!document.getElementById('crm')){
      ...
      section.innerHTML=
        '<div class="section-head"><div><p class="eyebrow">BUSINESS OPERATIONS</p><h2>CRM & ERP</h2><p class="muted">Supabase is the system of record. Google Workspace is the collaborative operating surface.</p></div>'+
        '<div class="crm-toolbar"><button class="btn secondary" id="crmRefreshBtn">Refresh</button><a class="btn secondary" href="'+WORKBOOK_URL+'" target="_blank" rel="noopener">Open Google workbook</a><button class="btn primary" id="crmNewLeadBtn">+ New lead</button></div></div>'+
